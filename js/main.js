...
function addGlobe() {
	...
	var clouds = new THREE.TextureLoader().load('/img/no_clouds.jpg');
...
$("#changeBackgroundButton").click(function () {
	...
	if ($("body").css("background-image") == 'url("https://static.pexels.com/photos/414171/pexels-photo-414171.jpeg")') {
		$("body").css("background-image", 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJYYIDJamzfOD577008nolVC9FYjT-3SD48w")');
	} else {
		$("body").css("background-image", 'url("https://static.pexels.com/photos/414171/pexels-photo-414171.jpeg")');
	}
});
